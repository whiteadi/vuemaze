...
<template>
  <div class="show-detail">
    ...
    <template v-else-if="show">
      ...
      <div class="show-detail__hero" :style="backgroundImage ? { '--bg-image': `url(${backgroundImage})` } : {}">
          ...
          <div class="show-detail__hero-info">
            ...
            <div class="show-detail__info">
              ...
              <div class="show-detail__meta">
                ...
                <span class="show-detail__status" :class="`show-detail__status--${show.status.toLowerCase()}`">
                  {{ show.status }}
                </span>
              </div>
